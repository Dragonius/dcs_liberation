...
DISTANCE_FROM_FRONTLINE = {
    ...
    CombatGroupRole.APC: (1700, 3700),
    CombatGroupRole.IFV: (1700, 3700),
    CombatGroupRole.ARTILLERY: (6000, 18000),
    CombatGroupRole.SHORAD: (3000, 8000),
    CombatGroupRole.LOGI: (8000, 20000),
    CombatGroupRole.INFANTRY: (1800, 3300),
    CombatGroupRole.ATGM: (1200, 6200),
    CombatGroupRole.RECON: (1000, 3000),
}
